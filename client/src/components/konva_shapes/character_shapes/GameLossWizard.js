...
import { Shape, Group, Circle } from "react-konva";
 ...
 export default class GameLossWizard extends React.Component {
    state = {
        ...
        <Circle
            ...
            <Shape
              sceneFunc={(context, shape) => {
                ...
                context.quadraticCurveTo(30, 35, 35, 45)
                context.fillStrokeShape(shape);
              }}
              shadowBlur={2}
              fill="Beige"
            ...
            <Shape
              sceneFunc={(context, shape) => {
                ...
                context.quadraticCurveTo(50, 35, 55, 45)
                context.fillStrokeShape(shape);
              }}
              shadowBlur={2}
              fill="Beige"
